...
// // Output -//{address:{city:"Dharmshala",state:"Himanchal pradesh"}}
...
console.log(movies[1].genres[0])
  ...
  let First=movies[0].actors[0]=="Rachel McAdams"?true:false
  console.log(First)
  ...
  let second=movies[1].actors[1]=="Natalie Portman"?true:false;
  console.log(second)
...
// 31..store all actors of aall movies in array name is "allactors"
let allactors=[]
  for(let movie of movies){
    for(actor of movie.actors){
...
console.log(game)
// Output - true
// 8)What does the following code print to the console and Why?
